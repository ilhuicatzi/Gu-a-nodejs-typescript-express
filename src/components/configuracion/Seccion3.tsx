      ...
      <div className="p-6">
        ...
        <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
          ...
          <li className="hover:text-foreground">
            ...
            Especifica el sistema de módulos que se utilizará.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `rootDir`:
            </span>
            Indica la ubicación de los archivos fuente.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `outDir`:
            </span>
            Define dónde se guardarán los archivos compilados.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `allowSyntheticDefaultImports`:
            </span>
            Permite importar módulos sin exportaciones predeterminadas.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `esModuleInterop`:
            </span>
            Facilita la interoperabilidad entre diferentes sistemas de módulos.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `forceConsistentCasingInFileNames`:
            </span>
            Asegura consistencia en el uso de mayúsculas y minúsculas en los
            nombres de archivo.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
            ...
            Activa todas las comprobaciones de tipo estrictas.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `noImplicitAny`:
            </span>
            Evita el uso implícito del tipo any.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `noUnusedLocals`:
            </span>
            Genera errores para variables locales no utilizadas.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `noUnusedParameters`:
            </span>
            Genera errores para parámetros de función no utilizados.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `noImplicitReturns`:
          ...
          <li className="hover:text-foreground">
            ...
            Evita caídas en las instrucciones switch.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `skipLibCheck`:
            </span>
            Omite la verificación de tipos en bibliotecas.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `noEmitOnError`:
            </span>
            Previene la emisión de archivos si hay errores.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `baseUrl` y `paths`:
            </span>
            Facilitan la importación de módulos desde rutas específicas.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `include`:
            </span>
            Especifica los archivos que se deben compilar.
          </li>
          <li className="hover:text-foreground">
            <span className="text-primary font-extralight font-mono">
              `exclude`:
            </span>
            Define qué archivos o carpetas se deben omitir en la compilación.
          </li>
        </ul>
      </div>
    </section>
